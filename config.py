...
class Config:
    def __init__(self, experiment):
        ...
        # predict ihd using rest data in from ukbb
            ...
            self.start=self.start_exercise
        # train classifier using ptbxl and cpsc data
        ...
        # extract feature using classifier trained from ukbb_st
        elif self.experiment in ['ukbb_feature']:
            self.num_workers = 2
            self.batch_size = 1
            self.checkpoint_path = 'checkpoints/resnet34/ukbb_st_b64.pth'
            self.length = 5000
            self.sampling_frequency = 500
            self.data_dir = self.dirs['ukbiobank']
            self.leads = ['I']
