...
def train_epoch(model, optimizer, criterion, train_dataloader: DataLoader, device):
    model.train()
...
def test_epoch(model, criterion, test_dataloader: DataLoader, device):
    model.eval()
    loss_sum, it_count = 0, 0
    out_list = []
    label_list = []
...
if __name__ == '__main__':
    for experiment in ['ptb_diag_super']:
